 ...
 */
final class Version20201120083904 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD author VARCHAR(255) NOT NULL, CHANGE author_id recipe_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP author, CHANGE recipe_id author_id INT NOT NULL');
